  ...
  return (
    <div className="h-full flex flex-col items-center justify-center gap-12 px-8">
      ...
      <div className="text-center">
        ...
        <h1 className="text-8xl md:text-9xl font-bold text-white drop-shadow-2xl">
      ...
      {correctAnswers.length > 0 && (
        <div className="w-full max-w-4xl">
          <h2 className="text-white text-3xl font-bold mb-6 text-center flex items-center justify-center gap-3">
